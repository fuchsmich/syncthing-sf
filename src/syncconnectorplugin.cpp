...
void QQuickSyncConnector::saveSettings()
{
    if (mSettingsLoaded) {
        ...
        mSettings.setValue("startStopWithAC", mStartStopWithAC);
    }
}
...
void QQuickSyncConnector::loadSettings()
{
    ...
    mStartStopWithAC = mSettings.value("startStopWithAC").toBool();
...
void QQuickSyncConnector::loadServiceUnitFile()
{
